 ...
 */
public interface NcbsCgmdabRlLoanRlvcService extends BaseService<NcbsCgmdabRlLoanRlvc, Long>{
    ...
    * @since
    */
    Page<NcbsCgmdabRlLoanRlvcOutVO> listPage(BaseQuery<NcbsCgmdabRlLoanRlvc> vo, UserVO userVO) throws Exception;
    ...
    * @since
    */
    NcbsCgmdabRlLoanRlvc saveOrUpdate(NcbsCgmdabRlLoanRlvc ncbsCgmdabRlLoanRlvc, UserVO userVO) throws Exception;
    ...
    * @since
    */
    NcbsCgmdabRlLoanRlvcOutVO queryInfoById(Long id) throws Exception;
