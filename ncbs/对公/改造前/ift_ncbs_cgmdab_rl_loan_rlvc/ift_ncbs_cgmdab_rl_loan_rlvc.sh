...
#***************************************************************
#系统名称： 税务管理系统
#脚本名称： ift_ecas_cgmdab_rl_loan_rlvc.sh
#脚本功能： 抵债资产零售贷款关联表
#
#版本        日期       编写者    项目组/修改内容
#-------   -------     -------  ----------
...
# 表名
org_table_name="cgmdab_rl_loan_rlvc"
# 维护日期所在列
...
TABLE_COLUMNS=--columns=commute_debt_ast_no,ln_due_bill_no,dtl_seri_no,cred_ast_impai_provis,inte_acct_acct_no,rcv_cost,pay_comp_price,repay_pri_amt,repay_int_amt,commute_debt_ast_assoc_stat,depr_retu_pri,depr_retu_int,retu_regu_pri,retu_overd_pri,retu_dead_ln_pri,retu_bad_debt_pri,retu_rece_accru_int,retu_rece_deb_int,retu_rece_accru_pena_int,retu_rece_pena_int,retu_on_bal_accru_compou_int,retu_on_bal_compou_int,retu_wri_off_pri,cred_ast_impai_provis_acct_no,to_be_deal_with_commute_debt_ast_occ_amt,contr_no,cust_no,revol_fund_amt,revol_amt1,revol_amt2,rese_fie,rese_fie_1,rese_fie_2,dispo_cost,to_be_retu_dispo_cost,retu_col_accru_int,retu_col_deb_int,retu_col_accru_pena_int,retu_col_pena_int,retu_off_bal_accru_compou_int,retu_off_bal_compou_int,retu_wri_off_int,retu_alr_wri_off_pri_int,retu_wri_off_int_compou_int,mainte_tell,mainte_inst,mainte_dt,mainte_tm,record_stat,overa_sit_aff_stat,overa_sit_aff_seq_no,optim_lock_vers_no,sys_timest
