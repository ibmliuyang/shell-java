...
#***************************************************************
#系统名称： 税务管理系统
#脚本名称： ift_ecas_ccllnb_non_perfmg_asset.sh
#脚本功能： 对公贷款不良资产登记簿
#
#版本        日期       编写者    项目组/修改内容
#-------   -------     -------  ----------
...
TABLE_COLUMNS=--columns=ln_due_bill_no,dtl_seri_no,cust_no,capital_src_acct_no,impai_provis_acct_no,impai_provis,repaym_tot_amt,repay_pri_amt,repay_int_amt,pri_tot,int_tot,tran_dt,tran_inst_no,tell_seq_no,wri_off_pri,wri_off_int,alr_wri_off_pri_int,wri_off_int_compou_int,ln_acct_stat,capital_src_acct_name,ln_form,bad_ast_tran_poss_stat,biz_inst_no,accoun_inst_no,bad_ast_tran_poss_manr,revol_fund_amt,revol_amt1,revol_amt2,rese_fie,rese_fie_1,rese_fie_2,retu_wri_off_pri,retu_wri_off_int,retu_alr_wri_off_pri_int,retu_wri_off_int_compou_int,mainte_tell,mainte_inst,mainte_dt,mainte_tm,record_stat
