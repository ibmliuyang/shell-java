...
for file in $files; do
    ...
    if [ -n "$maintain_date_col" ]; then
        ...
        awk -F '\\|\\+\\|' -v maintain_date_col="$maintain_date_col" -v today_with_dash="$today_with_dash" -v yesterday_with_dash="$yesterday_with_dash" '$maintain_date_col == yesterday_with_dash && $17==2 && ($54==2 || $54==3 || $54==4 || $54==5)' "$unzip_data_file" > "${work_dir}/temp.txt"
