...
public class NcbsCgmdabClLoanRlvc implements Serializable {
    ...
    */   
    ...
    //@NotBlank(message = "校验提示信息", groups = {GroupNcbsCgmdabClLoanRlvc.ScenarioSave.class})
    ...
    * 全局事务状态
    */
    @Column(name = "overa_sit_aff_stat")
    private String overaSitAffStat;
        
    /**        
    * 全局事务流水号
    */
    @Column(name = "overa_sit_aff_seq_no")
    private String overaSitAffSeqNo;
        
    /**        
    * 乐观锁版本号
    */
    @Column(name = "optim_lock_vers_no")
    private Long optimLockVersNo;
        
    /**        
    * 系统时间戳
    */
    @Column(name = "sys_timest")
    private Long sysTimest;
